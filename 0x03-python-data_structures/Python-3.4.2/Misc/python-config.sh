...
prefix_build="/usr/local/opt/python3.4"
...
SYSLIBS="$LIBM $LIBC"
ABIFLAGS="m"
LIBS="-ldl  $SYSLIBS -lpython${VERSION}${ABIFLAGS}"
...
LIBPL=$(echo "/usr/local/opt/python3.4/lib/python3.4/config-$(VERSION)$(ABIFLAGS)" | sed "s#$prefix_build#$prefix_real#")
SO="@SO@"
PYTHONFRAMEWORK=""
